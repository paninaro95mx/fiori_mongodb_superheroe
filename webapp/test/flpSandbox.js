		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MongoDB Fiori App",
									"targetURL": "#comassemblermongobdcapmongodbui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comassemblermongobdcapmongodbui5-display": {
								"semanticObject": "comassemblermongobdcapmongodbui5",
								"action": "display",
								"description": "MongoDB Fiori App",
								"title": "MongoDB Fiori App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.assembler.mongobd.cap.mongodbui5",
									"url": sap.ui.require.toUrl("com/assembler/mongobd/cap/mongodbui5")
								}
							}
						}
					}
