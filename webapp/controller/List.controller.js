sap.ui.define([
    ...
    return BaseController.extend("com.assembler.mongobd.cap.mongodbui5.controller.List", {
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("nombreSuperheroe", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "com.assembler.mongobd.cap.mongodbui5.view.ViewSettingsDialog",
                    controller: this
        ...
        onNewSuperheroePress: function() {
            var bReplace = !Device.system.phone;
            this.getModel("appView").setProperty("/layout", "TwoColumnsMidExpanded");
            this.getRouter().navTo("newSuperheroe", bReplace);
        },
